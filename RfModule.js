 ...
 */
var RfModule = /** @class */ (function () {
    function RfModule(tx_pin, rx_pin) {
        if (tx_pin === void 0) { tx_pin = null; }
        if (rx_pin === void 0) { rx_pin = null; }
    ...
    RfModule.prototype.initTX = function () {
        rpio.open(this.tx_pin, rpio.OUTPUT, rpio.LOW);
    };
    RfModule.prototype.initRX = function () {
        rpio.open(this.rx_pin, rpio.INPUT);
    };
    // Transmit a signal
    RfModule.prototype.send = function (message) {
    ...
    // Receive a signal
    RfModule.prototype.receive = function () {
        return __awaiter(this, void 0, void 0, function () {
            var value;
            return __generator(this, function (_a) {
                while (true) {
                    value = rpio.read(this.rx_pin);
                    if (value) {
